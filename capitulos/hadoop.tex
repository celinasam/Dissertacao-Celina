...
No HDFS, a codificação RS \emph{default} é (8, 5) e a XOR \emph{default} é (7, 5).  Logo, toleram até $l=3$ e até $l=2$ falhas, respectivamente, por \emph{stripe} de 5 blocos ($k=5$) com sobrecarga de $B=1.6$ e de $B=1.4$, respectivamente.
