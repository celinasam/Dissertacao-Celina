...
Códigos RS são projetados através da aritmética de corpos finitos e seus algoritmos de codificação e decodificação funcionam basicamente através de cálculos sobre polinômios. 

Corpos finitos também são chamados corpos de Galois, em homenagem ao matemático francês Évariste Galois.
