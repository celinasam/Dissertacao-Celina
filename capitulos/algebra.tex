...
\section{Grupo, Anel e Corpo de Galois}
...
\begin{definition} Seja $\alpha$ um elemento primitivo em $\mathbb{GF}_q, q=2^m$. Então $\alpha$ tem ordem $q -1$ e as potências distintas de $\alpha$ geram todos os elementos diferentes de $0$ de $\mathbb{GF}_q$.
\end{definition}
...
\begin{definition} {\bf Polinômio Gerador} \label{PolGer} \index{Polinômio Gerador}  
\end{definition}
