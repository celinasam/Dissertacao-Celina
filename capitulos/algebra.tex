...
\begin{definition} Um dado código de bloco linear é cíclico, se para cada um dos seus vetores de código a $i$-ésima rotação cíclica também é um vetor código.
\end{definition}
