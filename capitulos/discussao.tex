...
No HDFS, a codificação RS \emph{default} é (5, 2) e a XOR (RAID-5) é (5, 3).  Logo, toleram até $l=3$ e até $l=2$ falhas, respectivamente, por \emph{stripe} de 5 blocos ($k=3$) com sobrecarga de $B=2.5$ e de $B=1.6667$, respectivamente.
