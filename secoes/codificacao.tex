...
Existem vários algoritmos de codificação por apagamento \cite{Byers:1998}  \cite{Kubiatowicz:2000}. Alguns dos mais utilizados são códigos Reed-Solomon (RS), códigos Low-Density Parity-Check (LDPC) e códigos Tornado \cite{Mitzenmacher:2004} \cite{RTAD:2007}.
