...
Códigos RS são projetados através da aritmética de corpos finitos. Corpos finitos também são chamados corpos de Galois, em homenagem ao matemático francês Évariste Galois.
	...
	\subsection{Congruência} \index{Congruência}
...
corpo com $p^n$ elementos. Qualquer corpo com $p^n$ elementos é isomorfo à extensão de decomposição de $x^q - x, q = p^n$ sobre $GF(q)$.
		...
		\subsubsection{Aritmética de Corpo Binário}
		...
		\subsubsection{Propriedades dos Polinômios e suas Raízes}		
		...
		\subsection{Construção de um Código Corretor de Erros}
		\subsubsection{Métrica de Hamming}
